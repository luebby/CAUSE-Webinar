...
Within a randomized controlled trial $i$ is randomly assigend to $x_i$: $do(x)$. The connections to the *parents* of $X$ is cut:
...
`r icon::fa("hand-point-right", colour = "#00998A", size = 1.5)`Directed acyclic graphs may help to develop a framework to think about the data generating process.
